...
const MyFavorites = () => {
  ...
  return (
    ...
    <div className='flex flex-col gap-4 md:flex-row md:flex-wrap'>
      ...
      <Link className='text-sm font-bold flex flex-col justify-center space-y-4' to={`/beaches/${encodeURI(beach.data().sta_nm)}`}><li className='text-center'>{beach.data().sta_nm} 해수욕장</li>
